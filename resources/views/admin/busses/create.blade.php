                ...
                <div class="card-body">
                    <form method="POST" onsubmit="return from_to();" action="{{ route('admin.busses.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="reg_num" type="text" class="form-control @error('reg_num') is-invalid @enderror" autocomplete="reg_num" name="reg_num" value="{{ old('reg_num') }}" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" required autocomplete="new-price"  value="{{ old('price') }}">
					    ...
					    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="start_time" type="time" class="form-control @error('start_time') is-invalid @enderror" name="start_time" required autocomplete="start_time"  value="{{ old('start_time') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="time_to_reach" type="time" class="form-control @error('time_to_reach') is-invalid @enderror" name="time_to_reach" required autocomplete="time_to_reach"  value="{{ old('time_to_reach') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="seat_num" type="number" class="form-control @error('seat_num') is-invalid @enderror" name="seat_num" required autocomplete="seat_num"  value="{{ old('seat_num') }}">
