...
<div class="container mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('User Details of '.$user->username) }}</div>
                ...
                <div class="card-body">
                    <form method="POST"  action="{{ url('profile/'.$user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $user->username }}" required autocomplete="username" disabled>
