...
<div id="demo" class="carousel slide" data-ride="carousel"  style="margin-top: -50px;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{ asset('/assets/images/banner1.jpg') }}"  width="1100" height="600">
    </div>
    <div class="carousel-item">
      <img src="{{ asset('/assets/images/banner2.png') }}"  width="1100" height="600">
    </div>
...
<div class="container  mt-3">
    <div class="row">
        <div class="col-sm-6">
            <!-- Default form login -->
            <form class="border border-light p-5" onsubmit="return from_to();" action="{{ route('available_bus') }}" method="post">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="travel_date" class="col-md-4 col-form-label text-md-right">{{ __('Travel Date') }}<span class="required"> *</span></label>

                  <div class="col-md-6">    

<input type="text" id="nepali-datepicker" class="form-control mb-4 @error('travel_date') is-invalid @enderror" placeholder="Select Date" name="travel_date" required />
...
<input type="hidden" id="travel_day" name="travel_day">
        ...
        <div class="col-sm-4 mt-5 ml-5">
           ...
           <div class="list-group-flush">
              ...
              <div class="list-group-item">
                <p class="mb-0"> <i class="fas fa-clipboard-list fa-2x ml-1 mr-3" aria-hidden="true"></i>Plenty of choices</p>
              </div>
              <div class="list-group-item">
                <p class="mb-0"><i class="fab fa-angellist fa-2x mr-3" aria-hidden="true"></i>Unbeatable prices</p>
              <!-- </div> -->
            </div>
...
<div class="container mt-5 mb-5">
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <button class="btn btn-info"> <a href="{{ url('contact') }}" class="text-white text-decoration-none">Contact us </a></button>
    </div>
  </div>
</div>
